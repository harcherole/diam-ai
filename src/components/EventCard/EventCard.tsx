    ...
    <>
      ...
      >
        <button
          ...
          aria-label={`Agrandir l'image : ${event.title}`}
          className="relative aspect-[4/5] w-full cursor-zoom-in overflow-hidden bg-surface-100"
        >
          <img
            src={event.image}
            alt={event.title}
          ...
          />
          <span className="absolute inset-0 flex items-center justify-center bg-navy-950/0 opacity-0 transition-all duration-300 group-hover:bg-navy-950/25 group-hover:opacity-100">
